...
public class TestUnit {
	...
	public void TestGetPositionGeneral() {
		Unit u1 = new ImplementedUnit(1, 10, 32, Unit.UnitType.Attack, 100, 1, 1, 1.0, 50);
	...
	public void TestTakeDamagePositive() {
		Unit u1 = new ImplementedUnit(1, 10, 32, Unit.UnitType.Attack, 50, 3, 12, 1.0, 100);
	...
	public void TestTakeDamageNegative() {
		Unit u1 = new ImplementedUnit(1, 10, 32, Unit.UnitType.Defend, 100, 3, 12, 1.0, 50);
		u1.takeDamage(-10);
	...
	public void TestDealDamageGeneral() {
		Unit defender = new ImplementedUnit(1, 10, 32, Unit.UnitType.Defend, 100, 3, 12, 1.0, 50);
		Unit attacker = new ImplementedUnit(1, 10, 32, Unit.UnitType.Attack, 100, 27, 5, 1.0, 50);
